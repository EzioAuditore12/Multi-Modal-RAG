...
export function ChatEventAddon({ children, className, ...props }: ChatEventAddonProps) {
  return (
    <div
      className={cn('flex h-full w-10 shrink-0 justify-center pt-1 @md/chat:w-12', className)}
      {...props}>
      {children}
    </div>
  );
...
export function ChatEventAvatar({
  ...
  return (
    <Avatar className={cn('size-8 rounded-full @md/chat:size-10', className)} {...props}>
